...
import 'package:learn_numbers_flutter/ui/tracingScreen/numberPaintScreen.dart';
...
class _TracingScreenState extends State<TracingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
          Image.asset("assets/images/tracing/bg.webp", fit: BoxFit.fill,
    ...
    return Expanded(
      child: Container(
        ...
        child: ListView.builder(
          ...
          itemCount: tracingNumberDataList.length,
  ...
  _itemOfListNumber(int pos) {
    return InkWell(
      ...
      child: Container(
        ...
        margin: EdgeInsets.symmetric(horizontal: Sizes.width_5,vertical: Sizes.height_5),
        height: double.infinity,
        width: Sizes.width_60,
        child: Image.asset(tracingNumberDataList[pos].imgName.toString()),
      ),
    );
  }
